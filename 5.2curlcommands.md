...
### RO-Crate Deltablot Previewer (beta)
...
'{
  ...
  "scope":"file",
  "types":["preview"],
  "toolUrl":"https://gdcc.github.io/dataverse-previewers/previewers/betatest/ROCrateDeltablotPreview.html",
  "toolParameters": {
      "queryParameters":[
        {"fileid":"{fileId}"},
        {"siteUrl":"{siteUrl}"},
  ...
  "contentType":"application/deltablot"
}'
```
